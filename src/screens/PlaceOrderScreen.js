...
const PlaceOrderScreen = ({ history, match }) => {
  ...
  }, [navigate,dispatch, success, order,successUpdate]);

  const placeOrderHandler = () => {

    if (window.confirm("êtes-vous sûr de payer ?")) {
        ...
        <div className="row  order-detail">
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row ">
              ...
              <div className="col-md-8 center">
                ...
                <p> {cart.shippingAdress.adress} </p>
                <p>
                  Contact: {cart.shippingAdress.city}
                </p>
                <p>{""} </p>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                <h5>
                  <strong>Infos sur la commande</strong>
                </h5>
          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>
                  Address:{cart.shippingAdress.country}
                </p>
                <p>
